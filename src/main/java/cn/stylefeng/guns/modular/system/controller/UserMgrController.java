...
import cn.stylefeng.guns.modular.system.transfer.UserInfoDto;
...
public class UserMgrController extends BaseController {
    ...
    public String userInfo(Model model) {
        ...
        userDto.setScore(userService.selectScoreByUserId(userId));
        userDto.setTempScore(userService.selectTempScoreByUserId(userId));
        userDto.setGrade(userService.selectGradeByUserId(userId));
        userDto.setOrderNum(userService.selectOrderNumByUserId(userId));
